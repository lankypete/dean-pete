	...
	<div class="content wrapper wrapper--narrow">
		<div class="website">
			...
			<div class="website__photo">
				<a href="http://islandfishingboatrentals.ca/" target="blank"><img srcset="/assets/images/ifbr-screenshot-opt.jpg" alt="The IFBR homepage"></a>
			</div>
			...
			<div class="website__photo">
				<img srcset="/assets/images/making-of-ifbr-opt.jpg" alt="The Sketch file originally">
			</div>
			...
			<p><span class="website__tech-name">Post CSS - </span>Used as the CSS preprocessor for my highly organized CSS. For mixins, modules, color palettes, variables, etc.</p>
			...
			<div class="website__see-site">
				The site is right <a  href="http://islandfishingboatrentals.ca/" target="blank">Here</a>
			</div>
